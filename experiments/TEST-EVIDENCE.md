...
| NAT E7 (`run_nat.py`) | real Linux MASQUERADE router | **L2** | pass-through control succeeds; fresh NAT rerun observed no receiver packets | **inconclusive** - no preservation or rewrite claim without receiver packets |
