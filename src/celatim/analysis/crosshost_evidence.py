...
def _public_metric_record(record: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "packing_efficiency_diagnostic": record.get("packing_efficiency_diagnostic"),
        "method_wire_bytes": record.get("method_wire_bytes"),
        "method_wire_basis": record.get("method_wire_basis"),
        "wire_expansion": record.get("wire_expansion"),
        "useful_payload_ratio": record.get("useful_payload_ratio"),
        "carrier_units_per_payload_byte": record.get("carrier_units_per_payload_byte"),
        "method_wire_bytes_per_carrier_unit": record.get("method_wire_bytes_per_carrier_unit"),
        ...
        "timing": {
            ...
            "observed_recovery_rate_bps": timing_map.get("observed_recovery_rate_bps"),
            "native_goodput_bps": timing_map.get("native_goodput_bps"),
